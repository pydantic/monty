...
test('every snapshot kind carries the position of the suspending expression', async () => {
  ...
  try {
    ...
    t.deepEqual(osCall.position, {
      filename: '<python-input-2>',
      startLine: 2,
      startColumn: 1,
      endLine: 2,
      endColumn: 27,
    ...
    t.deepEqual(first.position, {
      filename: '<python-input-3>',
      startLine: 4,
      startColumn: 18,
      endLine: 4,
      endColumn: 25,
