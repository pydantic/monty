...
#[pyclass(extends=exceptions::PyException, module="pydantic_monty._monty", subclass)]
#[derive(Clone)]
...
#[pyclass(extends=MontyError, module="pydantic_monty._monty")]
#[derive(Clone)]
...
#[pyclass(name = "Frame", module = "pydantic_monty._monty", frozen)]
#[derive(Debug, Clone)]
pub struct PyFrame {
