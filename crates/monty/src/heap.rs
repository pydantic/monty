...
///
/// Owns the [`LimitedTracker`] that enforces memory/time limits and schedules
...
impl Heap {
    ...
    pub fn new(capacity: usize, tracker: LimitedTracker) -> Self {
        let this = Self {
...
#[cfg(test)]
mod tests {
    use monty_types::{LimitedTracker, ResourceLimits};
    ...
    fn cstack_only_cycle_survives_collection() {
        let mut heap = Heap::new(16, LimitedTracker::new(ResourceLimits::new()));
