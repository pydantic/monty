...
impl Codec {
    ...
    /// tracker.
    pub(crate) fn encode(self, s: &str, errors: &str, tracker: &LimitedTracker) -> RunResult<Vec<u8>> {
        match self {
...
fn encode_ascii(s: &str, errors: &str, tracker: &LimitedTracker) -> RunResult<Vec<u8>> {
