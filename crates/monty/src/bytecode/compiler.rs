...
impl<'a> Compiler<'a> {
    ...
    fn compile_comprehension_slot_saves(&mut self, generators: &[Comprehension]) -> Result<(), CompileError> {
    ...
    fn compile_comprehension_slot_restores(&mut self, generators: &[Comprehension]) -> Result<(), CompileError> {
