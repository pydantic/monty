...
impl_dict_iterator!(
    ...
    |this: &mut HeapRead<'h, DictKeyIterator>, vm: &mut VM<'h, _>| {
...
impl_dict_iterator!(
    ...
    |this: &mut HeapRead<'h, DictItemIterator>, vm: &mut VM<'h, _>| {
        let (dict_id, current_len) = {
            let dict_id = this.get(vm.heap).source_id();
            let HeapData::Dict(dict) = vm.heap.get(dict_id) else {
                unreachable!("dict iterator must retain a dict")
...
impl_dict_iterator!(
    ...
    |this: &mut HeapRead<'h, DictValueIterator>, vm: &mut VM<'h, _>| {
        let (dict_id, current_len) = {
            let dict_id = this.get(vm.heap).source_id();
            let HeapData::Dict(dict) = vm.heap.get(dict_id) else {
                unreachable!("dict iterator must retain a dict")
