...
fn str_lower(s: &str, vm: &VM<'_>) -> Value {
    allocate_string_with_interns(lowercase(s), vm.heap, vm.interns)
}

/// Implements Python's `str.upper()` method.
fn str_upper(s: &str, vm: &VM<'_>) -> Value {
    allocate_string_with_interns(uppercase(s), vm.heap, vm.interns)
}
...
fn str_casefold(s: &str, vm: &VM<'_>) -> Value {
    allocate_string_with_interns(casefold(s), vm.heap, vm.interns)
}
