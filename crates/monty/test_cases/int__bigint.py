...
assert 10**40 == 10000000000000000000000000000000000000000, 'computed bigint == interned bigint literal'
assert 10000000000000000000000000000000000000000 == 10**40, 'interned bigint literal == computed bigint'
assert 1267650600228229401496703205376 == 2.0**100, 'interned bigint literal == float exactly'
assert 2.0**100 == 1267650600228229401496703205376, 'float == interned bigint literal exactly'
