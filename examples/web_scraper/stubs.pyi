# Auto-generated by stubgen.sh — do not edit manually
...
class Page:
    ...
    async def go_to(self, url: str, wait_until: Literal['commit', 'domcontentloaded', 'load', 'networkidle'] = 'networkidle') -> None:
...
class Tag:
    ...
    text: str = ...
    html: str = ...
    def find(self, name: str | None = None, attrs: dict[str, str] | None = None, string: str | None = None) -> Tag | None:
        ...
        """
    def find_all(self, name: str | re.Pattern[str] | None = None, attrs: dict[str, str] | None = None, string: str | None = None, limit: int | None = None) -> list[Tag]:
