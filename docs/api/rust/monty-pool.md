...
session-preserving [`PoolError::Runtime`](#poolerror)). The session's first feed
...
included) unless [`Checkout::feed_with_cwd`](#checkout) switches it. Returns the
...
pub struct ReplConfig {
    ...
    pub auto_os_calls: monty_types::AutoOsCalls,
}
```

<div class="rust-decl-links" data-links="monty_types::ResourceLimits ../monty-types/#resourcelimits;monty_types::TypeCheckingConfig ../monty-types/#typecheckingconfig;monty_types::AssertMessageAnnotations ../monty-types/#assertmessageannotations;monty_types::AutoOsCalls ../monty-types/#autooscalls" hidden></div>
...
pub enum TurnEvent {
    ...
    FunctionCall { function_name: String, args: monty_types::CallArgs, call_id: u32, object_id: Option<monty_types::MontyUuid>, allow_eager_await: bool },
    ...
    /// no-handler default.
    OsCall { function_name: String, args: monty_types::CallArgs, call_id: u32, allow_eager_await: bool, system_sleep: Option<std::time::Duration> },
...
<div class="rust-decl-links" data-links="monty_types::CallArgs ../monty-types/#callargs;monty_types::MontyUuid ../monty-types/#montyuuid;monty_types::MontyObject ../monty-types/#montyobject" hidden></div>
