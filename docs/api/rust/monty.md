...
```rust
pub fn with_auto_os_calls(self, auto_os_calls: AutoOsCalls) -> Self
```

<div class="rust-decl-links" data-links="AutoOsCalls ../monty-types/#autooscalls" hidden></div>
...
[`MontyRun::with_auto_os_calls`](#montyrun).
