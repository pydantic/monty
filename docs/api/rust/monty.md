...
pub struct FunctionCall {
    ...
    pub position: monty_types::SourceRange,
    /* private fields */
}
```

<div class="rust-decl-links" data-links="monty_types::CallArgs ../monty-types/#callargs;monty_types::MontyUuid ../monty-types/#montyuuid;monty_types::SourceRange ../monty-types/#sourcerange" hidden></div>
...
<div class="rust-decl-links" data-links="monty_types::SourceRange ../monty-types/#sourcerange" hidden></div>
...
<div class="rust-decl-links" data-links="monty_types::OsFunctionCall ../monty-types/#osfunctioncall;monty_types::SourceRange ../monty-types/#sourcerange" hidden></div>
...
<div class="rust-decl-links" data-links="SourceRange ../monty-types/#sourcerange" hidden></div>
...
<div class="rust-decl-links" data-links="CompileOptions ../monty-types/#compileoptions" hidden></div>

The [`CompileOptions`](monty-types.md#compileoptions) every snippet fed to this session compiles with.
...
<div class="rust-decl-links" data-links="CheckedSource #checkedsource;MontyException ../monty-types/#montyexception" hidden></div>
...
(the worker type-checks after it); the returned [`CheckedSource`](#checkedsource) lets
[`feed_start_checked`](#montyrepl) skip the scan. Plain
...
The snippet is scanned for nesting first; [`feed_start_checked`](#montyrepl)
takes one [`check_source`](#montyrepl) already vetted.
...
<div class="rust-decl-links" data-links="CheckedSource #checkedsource;NamedValues ../monty-types/#namedvalues;PrintWriter ../monty-types/#printwriter;ReplProgress #replprogress;ReplStartError #replstarterror" hidden></div>

[`feed_start`](#montyrepl) for a snippet [`check_source`](#montyrepl)
already vetted, so the scan is not repeated.

#### Errors
As [`feed_start`](#montyrepl).
...
by [`SessionRef`](#sessionref) — keep the two sets of names in step.
...
<div class="rust-decl-links" data-links="monty_types::TypeCheckState ../monty-types/#typecheckstate;SessionRef #sessionref;DumpEncodeError #dumpencodeerror" hidden></div>
...
<div class="rust-decl-links" data-links="DumpDecodeError #dumpdecodeerror" hidden></div>
...
```rust
pub struct DumpDecodeError(/* private */);
```
...
Implements: `Debug`, `Display`, `Eq`, `Error`, `PartialEq`.

## DumpEncodeError

```rust
pub struct DumpEncodeError(/* private */);
```
...
```rust
pub struct CheckedSource<'a>(/* private */);
```

A snippet [`MontyRepl::check_source`](#montyrepl) found within the nesting bound,
which [`MontyRepl::feed_start_checked`](#montyrepl) therefore need not scan again.
