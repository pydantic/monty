...
pub fn os_call_to_proto(
    ...
    position: &monty_types::SourceRange,
) -> pb::OsCall;
```

<div class="rust-decl-links" data-links="monty_types::OsFunctionCall ../monty-types/#osfunctioncall;monty_types::SourceRange ../monty-types/#sourcerange;pb::OsCall #oscall" hidden></div>
...
Implements: `Clone`, `Debug`, `Default`, `Eq`, `From<&SourceRange>`, `From<SourceRange>`, `Hash`, `Message`, `PartialEq`, `StructuralPartialEq`.
...
<div class="rust-decl-links" data-links="Persistence #persistence" hidden></div>

Returns the enum value of `persistence`, or the default if the field is set to an invalid enum value.

#### set_persistence

```rust
pub fn set_persistence(&mut self, value: Persistence)
```

<div class="rust-decl-links" data-links="Persistence #persistence" hidden></div>

Sets `persistence` to the provided enum value.
...
pub struct ChildEvent {
    ...
    /// support persistence.
    pub session_id: ::core::option::Option<Vec<u8>>,
    pub kind: ::core::option::Option<child_event::Kind>,
}
```

<div class="rust-decl-links" data-links="Vec #budgetvec;child_event::Kind #kind" hidden></div>
...
<div class="rust-decl-links" data-links="WireArena #wirearena;SourceRange #sourcerange;os_call::Call #call" hidden></div>
...
<div class="rust-decl-links" data-links="Uuid #uuid;SourceRange #sourcerange" hidden></div>
...
<div class="rust-decl-links" data-links="Vec #budgetvec;SourceRange #sourcerange" hidden></div>
...
Returns `true` if `value` is a variant of `Persistence`.

#### from_i32

```rust
pub fn from_i32(value: i32) -> ::core::option::Option<Persistence>
```
...
Converts an `i32` to a `Persistence`, or `None` if `value` is not a valid variant.
...
Implements: `Clone`, `Copy`, `Debug`, `Default`, `Eq`, `From<Persistence>`, `Hash`, `Ord`, `PartialEq`, `PartialOrd`, `StructuralPartialEq`, `TryFrom<i32>`.
...
pub struct WireFunctionCall {
    ...
    pub position: Option<monty_types::SourceRange>,
}
```

<div class="rust-decl-links" data-links="WireArena #wirearena;BudgetVec #budgetvec;monty_types::unstable::NodeId ../monty-types/#nodeid;monty_types::MontyUuid ../monty-types/#montyuuid;monty_types::SourceRange ../monty-types/#sourcerange" hidden></div>
...
<div class="rust-decl-links" data-links="CallArgs ../monty-types/#callargs;MontyUuid ../monty-types/#montyuuid;SourceRange ../monty-types/#sourcerange" hidden></div>
