...
<div class="rust-decl-links" data-links="TextWrite #textwrite;BytesWrite #byteswrite;Open #open;Mkdir #mkdir;Rename #rename;Getenv #getenv;Unit #unit;DateTimeNow #datetimenow;Urandom #urandom;Sleep #sleep;AsyncSleep #asyncsleep" hidden></div>
...
<div class="rust-decl-links" data-links="SandboxTimeZone #sandboxtimezone;SleepMode #sleepmode;auto_os_calls::Datetime #datetime;auto_os_calls::RandomStart #randomstart" hidden></div>

Mirrors monty's `AutoOsCalls`: which OS calls the sandbox answers itself.
Each unset arm means that field's default.

Implements: `Clone`, `Debug`, `Default`, `From<&AutoOsCalls>`, `Message`, `PartialEq`, `StructuralPartialEq`, `TryFrom<AutoOsCalls>`.
...
<div class="rust-decl-links" data-links="ResourceLimits #resourcelimits;AutoOsCalls #autooscalls" hidden></div>
